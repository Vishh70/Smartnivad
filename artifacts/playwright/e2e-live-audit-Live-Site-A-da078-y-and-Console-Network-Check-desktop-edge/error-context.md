...
```
Error: Found console errors: [https://smartnivad1.vercel.app/] Console Error: Failed to load resource: the server responded with a status of 404 (), [https://smartnivad1.vercel.app/] Console Error: Failed to load resource: the server responded with a status of 404 ()
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::gxwsg-1784348617240-ed5ce454dfc6`"
