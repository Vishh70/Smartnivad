...
export default function LoginPage() {
  ...
  return (
    <div className="min-min-h-screen flex items-center justify-center p-4">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-gradient-to-r from-[var(--color-primary)]/20 to-blue-500/20 blur-[100px] -z-10 rounded-full" />
      ...
      <GlassCard className="w-full max-w-md p-8 md:p-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <GlowButton type="submit" variant="primary" className="w-full h-12 text-lg mt-4">
            Sign In
          </GlowButton>
        </form>
