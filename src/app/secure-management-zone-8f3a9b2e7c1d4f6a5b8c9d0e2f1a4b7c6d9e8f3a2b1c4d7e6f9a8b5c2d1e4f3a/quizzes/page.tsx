      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">
            View, edit, and create daily quiz answers.
          </p>
        </div>
        <Link href="/secure-management-zone-8f3a9b2e7c1d4f6a5b8c9d0e2f1a4b7c6d9e8f3a2b1c4d7e6f9a8b5c2d1e4f3a/quizzes/new">
            ...
            <tbody className="divide-y divide-white/5">
              {quizzes.map((quiz) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 rounded text-xs font-medium ${quiz.status === "PUBLISHED" ? "bg-green-500/20 text-green-400" : "bg-gray-500/20 text-gray-600"}`}
                    >
                      {quiz.status}
                    </span>
                  </td>
              ...
              {quizzes.length === 0 && (
                <tr>
                  ...
                  >
                    No quizzes found. Click &quot;Add New Quiz&quot; to create
                    one.
                  </td>
                </tr>
              )}
