      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">
            View, edit, and create affiliate stores.
          </p>
        </div>
        <Link href="/secure-management-zone-8f3a9b2e7c1d4f6a5b8c9d0e2f1a4b7c6d9e8f3a2b1c4d7e6f9a8b5c2d1e4f3a/stores/new">
            ...
            <tbody className="divide-y divide-white/5">
              ...
              {stores.length === 0 && (
                <tr>
                  ...
                  >
                    No stores found. Click &quot;Add New Store&quot; to create
                    one.
                  </td>
                </tr>
              )}
