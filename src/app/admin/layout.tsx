...
import { LayoutDashboard, Tags, List, HelpCircle, FileText, Settings } from "lucide-react";
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-min-h-screen bg-black flex">
      {/* Sidebar */}
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col min-min-h-screen max-w-full overflow-x-hidden">
